...
const Navhome2 = () => {
  ...
  return (
    ...
    <div className=' lg:flex bg-black 2k:hidden  hidden  items-center justify-center  '>
      <img
    ...
    <div className="  relative bg-black w-screen  h-[50px] 2k:h-[50px] flex  justice justify-between items-center  overflow-hidden text-center text-base  text-white font-audiowide pb-3 overflow-x-hidden">
    ...
    <div className="absolute bg-black   hidden lg:block 2k:hidden  top-[40px] h-[30px]">
      <div className='flex  items-center w-screen justify-center space-x-8  cursor-pointer glow-animation'>
        ...
        <a href={'./DoctorInfo'} className='text-white z-50 bg-black no-underline rounded-2xl'>Doctor  </a>

        <a href={'/doctor_create'} className='text-white z-20 no-underline'>New Doctor Registration </a>
      </div>
     
      <img
          className="absolute top-[16px] bg-black  mt-[13px]  w-screen overflow-hidden h-[26px]"
          alt=""
