...
const Dashboard = () => {
  return (
    <>
      <div className="h-screen w-full bg-black relative flex overflow-hidden">
        {/* Sidebar */}
        <aside className="h-full w-16 flex flex-col space-y-10 items-center justify-center relative bg-gray-500 text-white">
          {/* Profile */}
          ...
          {/* Courses */}
          <div className="h-10 w-10 flex items-center justify-center rounded-lg cursor-pointer hover:text-gray-500 hover:bg-white  hover:duration-300 hover:ease-linear focus:bg-white">
        ...
        <div className="w-full h-full flex flex-col justify-between">
          {/* Header */}
          <header className="h-16 w-full flex items-center relative justify-end px-5 space-x-10 bg-gray-700">
            {/* Informação */}
